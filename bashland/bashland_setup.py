...
def get_user_information_and_login(username=None, password=None, attempts=0):
    ...
    if username == None and password == None:
        print("Please enter your bashland credentials")
...
def get_mac_address():
    ...
    if (mac >> 40) & 1:
        ...
        # print("Using hostname (%s) to identify system" % hostname)
        mac = hostname
    else:
        mac = str(mac)
    return mac
...
def main():
    try:
        ...
        ascii_art = """\
            ...
            |  _ < / _` / __| '_ \  | |    / _` | '_ \ / _` |
            | |_) | (_| \__ \ | | |_| |___| (_| | | | | (_| |
            |____/ \__,_|___/_| |_(_)______\__,_|_| |_|\__,_|
                                                            
                                                            
        """

        print(ascii_art)
        print("Welcome to bashland setup!")
        ...
        if is_new_user:
            ...
            if register_result:
                ...
                print("You can rerun setup using 'bashland setup' in a new "
                      "terminal window.\n")
                sys.exit(0)
        ...
        if access_token == None:
            ...
            print("If you forgot your password please reset it. "
                  "https://bash.land/password-reset (TO Be Implemented)")
            print("You can rerun setup using 'bashland setup' in a new "
                  "terminal window.\n")
            sys.exit(0)
